...
# data settings
parser.add_argument("--data_dir", type=str, default="/home/xjy/OCTA/ROSE/ROSE-1/SVC/", help="path to folder for getting dataset")
...
parser.add_argument("--first_suffix", type=str, default="best_pred.pth", help="front_model-[model_suffix].pth will be loaded in models_dir")
